...
class ProductDetailView(APIView):
    ...
    def get_permissions(self):
        ...
        # / Swagger/Redoc documentation //////////
    @swagger_auto_schema(
            # request_body=serializers.AddCartItemRequestBody,
            responses={'200': serializers.ProductSerializer}
            )
...
class UploadProductImagesView(APIView):
    ...
    # / Swagger/Redoc documentation //////////
    @swagger_auto_schema(
        request_body=serializers.ProductImageUploadSerializer,
        responses={'200': serializers.ProductImageUploadSerializer}
        )
